// @ts-nocheck
var emailLabel, email, passwordLabel, password, showPasswordCheck, showPasswordToggle, mySVG, twoFingers, armL, armR, eyeL, eyeR, nose, mouth, mouthBG, mouthSmallBG, mouthMediumBG, mouthLargeBG, mouthMaskPath, mouthOutline, tooth, tongue, chin, face, eyebrow, outerEarL, outerEarR, earHairL, earHairR, hair, bodyBG, bodyBGchanged;
